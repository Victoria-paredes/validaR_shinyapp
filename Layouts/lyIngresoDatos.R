lyIngresoDatDscrp <- infoBox(
  width = 8, "Instrucciones", color = 'light-blue', icon = icon("info-circle"),
  h4("Los datos experimentales deben ingresarse en forma de series independientes que pueden ser univariados 
