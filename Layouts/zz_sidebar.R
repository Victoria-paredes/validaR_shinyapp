...
customSidebar <- dashboardSidebar(tags$style(".left-side, .main-sidebar {padding-top: 110px;}"), # font-size: larger
                     ...
                     sidebarMenu(id = "tabs",
                       ...
                       #bookmarkButton(label = 'Generar vínculo', 
                       #               title = paste0('Genera una dirección URL que guarda la información ingresada',
                      #                               'en la applicación para posteriormente acceder a la App en el estado actual.')),
                      # tags$hr(),
                       ...
                       tags$b('Parámetros de validación:', tags$br(), '(En proceso de implementación)'),
                       ...
                       tags$b('Recursos adicionales:', tags$br(), '(En proceso de implementación)'),
                       ...
                       menuItem("Reporte de errores, sugerencias:", icon = icon("bug"),
                                href = "https://github.com/Crparedes/validaR_shinyapp/issues")))