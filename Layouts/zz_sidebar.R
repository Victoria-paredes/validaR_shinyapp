...
customSidebar <- dashboardSidebar(tags$style(".left-side, .main-sidebar {padding-top: 110px;}"), # font-size: larger
                     ...
                     sidebarMenu(id = "tabs",
                       ...
                       tags$b('Parámetros de validación: (En proceso de implementación)'),
                       ...
                       tags$b('Recursos adicionales: (En proceso de implementación)'),
